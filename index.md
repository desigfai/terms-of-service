...
* While the App serves as an open-ended narrative engine for private fictional storytelling, we maintain a strict, zero-tolerance policy for attempts to generate illegal content, Child Sexual Abuse Material (CSAM), non-consensual deepfakes of real individuals, or content promoting real-world violence. Generating such content will result in immediate account termination.
